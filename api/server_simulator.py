...
def aum_server():
    ...
    """
    while True:
        logging.info("aum server: START, about to generate new split")
...
def controller_server_pp():
    ...
    while True:
        ...
        tmp = post_requests(json.dumps(account_info), CONFIG["url_posi_server"])
        if str(tmp).startswith("20"):
